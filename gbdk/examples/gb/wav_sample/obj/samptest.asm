...
;src/samptest.c:30: while (joypad() & J_A) wait_vbl_done();
00101$:
	call	_joypad
	bit	4, a
	jr	Z, 00111$
...
;src/samptest.c:33: play_sample2();
	...
	ld	hl, #_play_sample2
	call	___sdcc_bcall_ehl
;src/samptest.c:34: while (joypad() & J_B) wait_vbl_done();
00104$:
	call	_joypad
	bit	5, a
	jr	Z, 00111$
	...
	jr	00104$
00111$:
;src/samptest.c:36: wait_vbl_done();
	call	_wait_vbl_done
;src/samptest.c:38: }
	jr	00113$
___str_0:
