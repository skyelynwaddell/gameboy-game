...
;dscan.c:121: if(DEVICE_SUPPORTS_COLOR) {
	...
	sub	a, #0x11
	ret	NZ
;../../../include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	ld	l, c
;	spillPairReg hl
;	spillPairReg hl
	ld	h, #0x00
...
;dscan.c:720: }
	add	sp, #11
	ret
;dscan.c:725: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
;../../../include/gb/gb.h:743: __asm__("di");
	di
...
;dscan.c:741: DISPLAY_ON;
	...
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
;../../../include/gb/gb.h:727: __asm__("ei");
	ei
;dscan.c:744: while(1) {
00102$:
